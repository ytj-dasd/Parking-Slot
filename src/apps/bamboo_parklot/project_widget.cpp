...
#include "actions/auto_detection_action.h"
#include "actions/import_layers_action.h"
#include "actions/import_detection_action.h"
#include "actions/export_layer_as_dxf_action.h"
#include "actions/export_cloud_action.h"
...
ProjectWidget::ProjectWidget(QWidget *parent)
    ...
    _auto_detection_action = new AutoDetectionAction(this);
    this->registeAction(_auto_detection_action);
    _import_layers_action = new ImportLayersAction(this);
    this->registeAction(_import_layers_action);
    _import_detection_action = new ImportDetectionAction(this);
    this->registeAction(_import_detection_action);
    _export_layer_action = new ExportLayerAsDxfAction(this);
    this->registeAction(_export_layer_action);
    _export_cloud_action = new ExportCloudAction(this);
    this->registeAction(_export_cloud_action);

    _toolbar_project->setVisible(true);
    _toolbar_project->addSeparator();

    this->addActionToToolBar("auto_detection", _toolbar_project, false);
    this->addActionToToolBar("import_layers", _toolbar_project, false);
    this->addActionToToolBar("import_detection", _toolbar_project, false);
    this->addActionToToolBar("export_layer_as_dxf", _toolbar_project, false);
    this->addActionToToolBar("export_cloud", _toolbar_project, false);
...
void ProjectWidget::setMainViewer(MainViewer* main_viewer) {
    ...
    _import_detection_action->setMainViewer(main_viewer);
    _export_layer_action->setMainViewer(main_viewer);
    _export_cloud_action->setMainViewer(main_viewer);
}
